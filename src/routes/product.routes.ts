...
// Use .any() to accept any field names for images
router.post("/", requireAuth, requireRole(["admin"]), upload.any(), Product.createProduct);
router.patch("/:id", requireAuth, requireRole(["admin"]), upload.any(), Product.updateProduct);
